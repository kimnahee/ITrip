...
public interface CbtCustomService {
	...
	int cbtCustomHderInsert(CbtCustomHderVO vo); //제출하기버튼 클릭시 문제지등록
	...
	List<CbtGuideVO> cbtCustomListO(CbtGuideVO vo); //맞은문제리스트
	List<CbtGuideVO> cbtCustomListX(CbtGuideVO vo); //틀린문제리스트
}
