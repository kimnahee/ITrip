   ...
   private final CustomLoginFailHandler loginFailHandler;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((requests) ->  requests
							.antMatchers("/", "/loginForm.do","/signupForm.do", "/login","/memberInsert.do", "/chk/**","/memberSearchForm.do","/memberSearch.do","/memberSearchList.do","/memberPwUpdateForm.do","/memberPwUpdate.do").permitAll()
